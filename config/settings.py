...
LOW_MEMORY_MODE = bool_env("LOW_MEMORY_MODE", IS_RENDER)
...
ENABLE_LONGFORM_AUTOMATION = bool_env("ENABLE_LONGFORM_AUTOMATION", not LOW_MEMORY_MODE)
LONGFORM_MIN_VIDEOS_PER_DAY = int(os.getenv("LONGFORM_MIN_VIDEOS_PER_DAY", "2"))
LONGFORM_MAX_VIDEOS_PER_DAY = int(os.getenv("LONGFORM_MAX_VIDEOS_PER_DAY", "5"))
LONGFORM_MIN_DURATION_SECONDS = int(os.getenv("LONGFORM_MIN_DURATION_SECONDS", "180"))
LONGFORM_MAX_DURATION_SECONDS = int(os.getenv("LONGFORM_MAX_DURATION_SECONDS", "300"))
LONGFORM_TARGET_WIDTH = int(os.getenv("LONGFORM_TARGET_WIDTH", "1280" if LOW_MEMORY_MODE else "1920"))
LONGFORM_TARGET_HEIGHT = int(os.getenv("LONGFORM_TARGET_HEIGHT", "720" if LOW_MEMORY_MODE else "1080"))
...
FREEBGMUSIC_API_KEY = env_or_default("FREEBGMUSIC_API_KEY", "")
...
INSTAGRAM_TOKEN = env_or_default("INSTAGRAM_TOKEN", "")
INSTAGRAM_ACCOUNT_ID = env_or_default("INSTAGRAM_ACCOUNT_ID", "")
INSTAGRAM_USER_NAME = env_or_default("INSTAGRAM_USER_NAME", "")
INSTAGRAM_GRAPH_API_VERSION = env_or_default("INSTAGRAM_GRAPH_API_VERSION", "v24.0")
INSTAGRAM_API_TIMEOUT_SECONDS = int(os.getenv("INSTAGRAM_API_TIMEOUT_SECONDS", "120"))
INSTAGRAM_PUBLISH_TIMEOUT_SECONDS = int(os.getenv("INSTAGRAM_PUBLISH_TIMEOUT_SECONDS", "900"))
INSTAGRAM_STATUS_POLL_SECONDS = int(os.getenv("INSTAGRAM_STATUS_POLL_SECONDS", "10"))
INSTAGRAM_SHARE_TO_FEED = os.getenv("INSTAGRAM_SHARE_TO_FEED", "True").lower() == "true"
ENABLE_INSTAGRAM_PRIVATE_FALLBACK = bool_env("ENABLE_INSTAGRAM_PRIVATE_FALLBACK", False)
INSTAGRAM_GRAPH_BASE_URL = env_or_default("INSTAGRAM_GRAPH_BASE_URL", "https://graph.instagram.com")
INSTAGRAM_GRAPH_FALLBACK_BASE_URL = env_or_default("INSTAGRAM_GRAPH_FALLBACK_BASE_URL", "https://graph.facebook.com")
...
DEFAULT_VIDEO_WIDTH = int(os.getenv("DEFAULT_VIDEO_WIDTH", "540" if LOW_MEMORY_MODE else "720"))
DEFAULT_VIDEO_HEIGHT = int(os.getenv("DEFAULT_VIDEO_HEIGHT", "960" if LOW_MEMORY_MODE else "1280"))
DEFAULT_RENDER_FPS = int(os.getenv("DEFAULT_RENDER_FPS", "15" if LOW_MEMORY_MODE else "18"))
MAX_SCENES_PER_VIDEO = int(os.getenv("MAX_SCENES_PER_VIDEO", "4" if LOW_MEMORY_MODE else "5"))
USE_STOCK_MEDIA = bool_env("USE_STOCK_MEDIA", True)
STOCK_MEDIA_MAX_SEARCH_QUERIES_PER_SCENE = int(os.getenv("STOCK_MEDIA_MAX_SEARCH_QUERIES_PER_SCENE", "2"))
STOCK_MEDIA_MAX_CANDIDATES_PER_QUERY = int(os.getenv("STOCK_MEDIA_MAX_CANDIDATES_PER_QUERY", "4"))
STOCK_MEDIA_MIN_REAL_SCENE_TARGET = int(os.getenv("STOCK_MEDIA_MIN_REAL_SCENE_TARGET", "3"))
