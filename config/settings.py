...
ENABLE_LONGFORM_AUTOMATION = bool_env("ENABLE_LONGFORM_AUTOMATION", True)
...
LONGFORM_TARGET_WIDTH = int(os.getenv("LONGFORM_TARGET_WIDTH", "1920"))
LONGFORM_TARGET_HEIGHT = int(os.getenv("LONGFORM_TARGET_HEIGHT", "1080"))
