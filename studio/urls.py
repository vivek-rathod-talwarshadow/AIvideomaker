...
urlpatterns = [
    ...
    path("dashboard/brainrot/", start_brainrot_project, name="start-brainrot-project"),
    path("dashboard/mode/", set_brainrot_mode, name="set-brainrot-mode"),
